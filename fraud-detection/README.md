...
Modèle de machine learning pour la détection de transactions frauduleuses, entraîné sur le dataset [Credit Card Fraud Detection](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud) de l'ULB / Worldline.
...
Télécharger `creditcard.csv` depuis [Kaggle](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud) (~150 Mo) et le déposer dans `data/`. Le fichier est exclu du dépôt git (`.gitignore`).
...
-   Le Borgne & Bontempi --- *Reproducible Machine Learning for Credit Card Fraud Detection*, Practical Handbook ([fraud-detection-handbook.github.io](https://fraud-detection-handbook.github.io/fraud-detection-handbook))
